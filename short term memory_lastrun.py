...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\psycho py\\short term memory\\short term memory_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='A series of words will appear , each word lasting for a short periods of time \ntry to remember them \n\npress spacebar to continue ',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textwait = visual.TextStim(win=win, name='textwait',
        text="Press either 'Y' for yes and 'N' for no if it was from study words\n\npress spacebar to continue",
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('studyWord.xlsx', selection='0:10'),
    ...
    for thisTrial in trials:
        ...
        text_3.setColor(WordColour, colorSpace='rgb')
        text_3.setText(WordItem)
        # keep track of which components have finished
        studytrialComponents = [text_3]
    ...
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    waitComponents = [textwait, key_resp_3]
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('studyWord.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('test_trials.started', globalClock.getTime(format='float'))
        text_5.setText(WordItem
        )
        ...
        _key_resp_4_allKeys = []
        # keep track of which components have finished
        test_trialsComponents = [text_5, key_resp_4]
        ...
        for thisComponent in test_trialsComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('test_trials.stopped', globalClock.getTime(format='float'))
        # check responses
